...
node GraphQL ecosystem, so it's not really surprising that projects don't set it
up since there isn't usually documentation showing tests.
...
it's a solid pick for a new project. The next project I'm working on is using
[Blitz.js](https://blitzjs.com/) which utilizes Prisma 2 for the default
database client, should be fun!
