...
1. Documentation
1. Source Code
1. Community Resources, esp those monitored by maintainers (StackOverflow,
   Github Issues, etc)
1. Podcasts
1. Books
...
capability to see how someone else is working and learning mroe things that I
...
this really easy to get started doing, and the mainteners of projects almost
