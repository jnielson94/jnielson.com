...
published: true
banner: ./undraw_Problem_solving.png
---
...
![WarningScreenshot.png](./WarningScreenshot.png)
...
A prime example of messed up styling was brought up by my coworker, Zack, had
filed [an issue with Next.js](https://github.com/vercel/next.js/issues/16796)
about styles not being correct, and then asked in our work slack if anyone
wanted to dig into it. I looked at
...
<CodeSandbox codeSandboxId="react-ssr-patching-issue-example-ok3m7" />
...
In order to fix this example there's a few things you can do:
...
I'll get more into those solutions later, but first...
...
![IssueScreenshot.png](./IssueScreenshot.png)
